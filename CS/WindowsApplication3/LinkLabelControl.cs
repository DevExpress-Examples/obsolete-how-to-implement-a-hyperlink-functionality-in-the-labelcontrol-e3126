...
namespace DXSample
{
    public class LinkLabelControl : LabelControl
    {
        ...
        private string GetLinkText(MouseEventArgs e)
        {
            ...
            List<StringBlock> blocks = pr.GetValue(ViewInfo.StringInfo, null) as List<StringBlock>;
            ...
            List<Rectangle> blocksBounds = pr.GetValue(ViewInfo.StringInfo, null) as List<Rectangle>;
