...
Namespace DXSample
	Public Class LinkLabelControl
		...
		Private Function GetLinkText(ByVal e As MouseEventArgs) As String
			...
			Dim blocks As List(Of StringBlock) = ViewInfo.StringInfo.Blocks
			...
			Dim blocksBounds As List(Of Rectangle) = ViewInfo.StringInfo.BlocksBounds
	...
	Public Class LinkLabelControlViewInfo
		...
		Protected Friend Shadows Property StringInfo() As StringInfo
			Get
				Return MyBase.StringInfo
			End Get
			Set(ByVal value As StringInfo)
				MyBase.StringInfo = value
			End Set
		End Property
	End Class
